...
public class SecondsDownButton : ButtonUI {
    ...
    protected override void OnStart() {
        ...
        uiManager.OnButtonSecondsDown += () => {
            if (activeState == SettingStates.Work) timerManager.SetWorkMinutes(-.5f);
            else timerManager.SetBreakMinutes(-.5f);
        };
